...
Gem::Specification.new do |spec|
  ...
  spec.homepage      = "https://github.com/janstilau/cocoapods-dev-env"
  spec.license       = "MIT"

  spec.metadata["allowed_push_host"] = "https://rubygems.org"

  spec.metadata["homepage_uri"] = spec.homepage
  spec.metadata["source_code_uri"] = "https://github.com/janstilau/cocoapods-dev-env.git"
  #spec.metadata["changelog_uri"] = "TODO: Put your gem's CHANGELOG.md URL here."

  # Keep packaging deterministic even before a newly added source file has
  # been committed locally.
  spec.files         = Dir.chdir(File.expand_path(__dir__)) do
    Dir['lib/**/*', 'LICENSE.txt', 'README.md', 'CODE_OF_CONDUCT.md'].select { |path| File.file?(path) }
  end
  spec.bindir        = "exe"
